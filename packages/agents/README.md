...
Wire AI tools into a running `<DocxEditor>` so `add_comment`, `suggest_change`, `insert_text`, `replace_text`, `set_content_control`, `insert_table`, `insert_image`, `find_text` etc. show up live in the user's editor.
