...
If you are building a product UI, start with the live editor. If you have documents and no UI, start with `DocxReviewer`. Pick MCP only when the client already speaks MCP.
